...
!!! Warning
    ...
    Be sure to use the `microbiome` Codespace when initiating VM for this practical. Note if instructed to use 'microbiome_lite' please type 'source ~/.bashrc' into the terminal after it loads.
